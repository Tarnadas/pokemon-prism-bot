...
exports.default = begin_patch;
const BSP_RESULT = exports.BSP_RESULT = {
  ERROR: -1,
  MENU: 0,
  SUCCESS: 1
};

function begin_patch(bsp, input, option) {
  return new Promise(resolve => {
    ...
    patcher.menu = options => {
      if (option != null) {
        ...
        resolve([BSP_RESULT.MENU, options, messages]);
      }
    };
    patcher.error = err => {
      resolve([resolve.ERROR, `Error: ${err.toString()}`]);
    };
    patcher.failure = status => {
      resolve([BSP_RESULT.ERROR, `Patch exited with status ${status.toString()}`]);
    };
    patcher.success = data => {
      resolve([BSP_RESULT.SUCCESS, data]);
    };
    patcher.run(option);
  });
}
...
function BSPPatcher(bsp, input) {
  ...
  function ResizableMemoryBlock(initial_size = 0) {
    ...
    function shrink(size) {
      ...
      var old_offset = current_size & 8191,
          new_offset = size & 8191;
    ...
    self.generate_array_buffer = function () {
      ...
      var part_count = current_size >>> 13,
          extra_offset = current_size & 8191;
      var pos;
    ...
    self.calculate_sha1 = function () {
      ...
      function mixing_function(counter, first, second, third) {
        if (counter < 20) return (first & second | ~first & third) >>> 0;else if (counter >= 40 && counter < 60) return (first & second | first & third | second & third) >>> 0;else return (first ^ second ^ third) >>> 0;
      }
      ...
      var pos, buf;
      for (pos = 0; pos < (current_size & 0xffffffc0) >>> 0; pos += 64) state = process_block(state, new DataView(parts[pos >>> 13].buffer.slice(pos & 8191, (pos & 8191) + 64)));
  ...
  function utf8_decode(address) {
    ...
    while ((next = get_byte(address++)) !== 0) {
      ...
      if (next == 0xe0 && peek < 0xa0 || next == 0xed && peek >= 0xa0 || next == 0xf0 && peek < 0x90 || next == 0xf4 && peek >= 0x90) throw "invalid UTF-8 string";
      if (next < 0xe0) {
        remaining = 1;
  ...
  function multiply(first, second) {
    ...
    var first_lower = first & 0xffff,
        first_upper = first >>> 16 & 0xffff;
    var second_lower = second & 0xffff,
        second_upper = second >>> 16 & 0xffff;
    var result_lower = first_lower * second_lower,
        result_upper = first_lower * second_upper + first_upper * second_lower;
  ...
  function xordata_opcode(start, len) {
    ...
    if (bytes_to_end >= len) xor_data(current_file_pointer, start, len);else {
  ...
  function ipspatch_opcode(variable, address) {
    ...
    while (true) {
      ...
      } else while (count--) file_buffer.set_byte(position++, get_next_byte());
    }
  ...
  function bufchar_opcode(character) {
    ...
    if (character > 0xffff) frames[0].message_buffer += String.fromCharCode(0xd800 | character - 0x10000 >>> 10) + String.fromCharCode(0xdc00 | character & 0x3ff);else if (character > 0) frames[0].message_buffer += String.fromCharCode(character);
    return true;
  }
  ...
  function bit_shifting_opcode(bitflags, variable) {
    ...
    var value;
    if (bitflags & 0x80) value = next_patch_variable();else value = next_patch_word();
  ...
  function long_multiply(first, second) {
    ...
    var first_low = first & 0xffff,
        first_high = first >>> 16,
        second_low = second & 0xffff,
        second_high = second >>> 16;
    var low = first_low * second_low,
        mid = first_low * second_high + first_high * second_low,
  ...
  function opcode_function(opcode) {
    switch (opcode) {
      ...
      case 0x0c:
        return readbyte_opcode;
      case 0x0d:
        return readhalfword_opcode;
      case 0x0e:
        return readword_opcode;
      case 0x0f:
        return pos_opcode;
      case 0x10:case 0x11:
        return getbyte_opcode;
      case 0x12:case 0x13:
        return gethalfword_opcode;
      case 0x14:case 0x15:
        return getword_opcode;
      case 0x16:case 0x17:
        return checksha1_opcode;
      case 0x18:case 0x19:
        return writebyte_opcode;
      case 0x1a:case 0x1b:
        return writehalfword_opcode;
      case 0x1c:case 0x1d:
        return writeword_opcode;
      case 0x1e:case 0x1f:
        return truncate_opcode;
      ...
      case 0x2c:case 0x2d:case 0x2e:case 0x2f:
        return guarded_calculation("/"); // divide
      case 0x30:case 0x31:case 0x32:case 0x33:
        return guarded_calculation("%"); // remainder
      case 0x34:case 0x35:case 0x36:case 0x37:
        return calculation("&"); // and
      case 0x38:case 0x39:case 0x3a:case 0x3b:
        return calculation("|"); // or
      case 0x3c:case 0x3d:case 0x3e:case 0x3f:
        return calculation("^"); // xor
      case 0x40:case 0x41:case 0x42:case 0x43:
        return conditional_jump_opcode("<"); // iflt
      case 0x44:case 0x45:case 0x46:case 0x47:
        return conditional_jump_opcode("<="); // ifle
      case 0x48:case 0x49:case 0x4a:case 0x4b:
        return conditional_jump_opcode(">"); // ifgt
      case 0x4c:case 0x4d:case 0x4e:case 0x4f:
        return conditional_jump_opcode(">="); // ifge
      case 0x50:case 0x51:case 0x52:case 0x53:
        return conditional_jump_opcode("==="); // ifeq
      case 0x54:case 0x55:case 0x56:case 0x57:
        return conditional_jump_opcode("!=="); // ifne
      case 0x58:case 0x59:
        return instruction_if_zero(jump_opcode, true); // jumpz
      case 0x5a:case 0x5b:
        return instruction_if_zero(jump_opcode, false); // jumpnz
      case 0x5c:case 0x5d:
        return instruction_if_zero(call_opcode, true); // callz
      case 0x5e:case 0x5f:
        return instruction_if_zero(call_opcode, false); // callnz
      case 0x60:case 0x61:
        return seek_opcode;
      case 0x62:case 0x63:
        return seekfwd_opcode;
      case 0x64:case 0x65:
        return seekback_opcode;
      case 0x66:case 0x67:
        return seekend_opcode;
      case 0x68:case 0x69:
        return print_opcode;
      case 0x6a:case 0x6b:
        return menu_opcode;
      case 0x6c:case 0x6d:case 0x6e:case 0x6f:
        return xordata_opcode;
      case 0x70:case 0x71:case 0x72:case 0x73:
        return fillbyte_opcode;
      case 0x74:case 0x75:case 0x76:case 0x77:
        return fillhalfword_opcode;
      case 0x78:case 0x79:case 0x7a:case 0x7b:
        return fillword_opcode;
      case 0x7c:case 0x7d:case 0x7e:case 0x7f:
        return writedata_opcode;
      case 0x80:
        return lockpos_opcode;
      case 0x81:
        return unlockpos_opcode;
      case 0x82:
        return truncatepos_opcode;
      case 0x83:
        return jumptable_opcode;
      case 0x84:case 0x85:
        return set_opcode;
      case 0x86:case 0x87:
        return ipspatch_opcode;
      case 0x88:case 0x89:case 0x8a:case 0x8b:
        return stackwrite_opcode;
      case 0x8c:case 0x8d:
        return stackread_opcode;
      case 0x8e:case 0x8f:
        return stackshift_opcode;
      case 0x90:
        return instruction_if_zero(return_opcode, true); // retz
      case 0x91:
        return instruction_if_zero(return_opcode, false); // retnz
      case 0x92:
        return pushpos_opcode;
      case 0x93:
        return poppos_opcode;
      case 0x94:case 0x95:case 0x96:case 0x97:
        return bsppatch_opcode;
      case 0x98:
        return getbyteinc_opcode;
      case 0x99:
        return gethalfwordinc_opcode;
      case 0x9a:
        return getwordinc_opcode;
      case 0x9b:
        return increment_opcode;
      case 0x9c:
        return getbytedec_opcode;
      case 0x9d:
        return gethalfworddec_opcode;
      case 0x9e:
        return getworddec_opcode;
      case 0x9f:
        return decrement_opcode;
      case 0xa0:case 0xa1:
        return bufstring_opcode;
      case 0xa2:case 0xa3:
        return bufchar_opcode;
      case 0xa4:case 0xa5:
        return bufnumber_opcode;
      case 0xa6:
        return printbuf_opcode;
      case 0xa7:
        return clearbuf_opcode;
      case 0xa8:case 0xa9:
        return setstacksize_opcode;
      case 0xaa:
        return getstacksize_opcode;
      case 0xab:
        return bit_shifting_opcode;
      case 0xac:
        return getfilebyte_opcode;
      case 0xad:
        return getfilehalfword_opcode;
      case 0xae:
        return getfileword_opcode;
      case 0xaf:
        return getvariable_opcode;
      case 0xb0:case 0xb1:case 0xb2:case 0xb3:
        return addcarry_opcode;
      case 0xb4:case 0xb5:case 0xb6:case 0xb7:
        return subborrow_opcode;
      case 0xb8:case 0xb9:case 0xba:case 0xbb:
        return longmul_opcode;
      case 0xbc:case 0xbd:case 0xbe:case 0xbf:
        return longmulacum_opcode;
      default:
        throw "undefined opcode";
    }
  }
  ...
  function finish() {
    ...
    switch (get_state()) {
      case 2:
        callback = self.error;break;
      case 3:
        callback = self.failure;break;
      case 4:
        callback = self.success;break;
      default:
        return;
    }
    frames = undefined;
