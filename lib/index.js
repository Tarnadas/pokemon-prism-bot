...
(async () => {
  ...
  const bsp = toArrayBuffer((await (0, _got2.default)(bspUrl)).body);

  client.login(_secret.botToken);
  ...
  client.on("message", async message => {
    ...
    message.attachments.forEach(async attachment => {
      ...
      const file = toArrayBuffer((await (0, _got2.default)(attachment.url)).body);
      ...
      try {
        ...
        // PATCH IT BABY
        const patchedFile = await (0, _bsppatch2.default)(file, bsp);
